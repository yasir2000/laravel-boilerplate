...
class SetupHRPermissions extends Command
{
    protected $signature = 'hr:setup-permissions';
    protected $description = 'Set up HR module permissions and roles';

    public function handle()
    {
        $this->info('Setting up HR permissions and roles...');
        ...
        $this->info('Created role: hr-manager');
        ...
        $this->info('Created role: department-manager');
        ...
        $hrSpecialist->syncPermissions($hrSpecialistPermissions);
        $this->info('Created role: hr-specialist');
        ...
        $this->info('Created role: team-lead');
        ...
        $hrEmployee->syncPermissions($hrEmployeePermissions);
        $this->info('Created role: hr-employee');

        $this->info('HR permissions and roles have been set up successfully!');
